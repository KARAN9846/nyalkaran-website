...
//             connected digital capabilities together so each part can support
//             the bigger picture.
//           </p>
//         </div>
...
//               className="group rounded-3xl border border-[#E4E7EC] bg-[#F8FAFC] p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:border-[#F65011]/25 hover:bg-white hover:shadow-[0_18px_40px_rgba(16,24,40,0.07)] sm:p-7"
//             >
...
//                 <span className="flex h-8 w-8 items-center justify-center rounded-full border border-[#E4E7EC] text-xs text-[#667085] transition-all duration-300 group-hover:border-[#F65011] group-hover:bg-[#F65011] group-hover:text-white">
...
//               <div
//                 aria-hidden="true"
//                 className="mt-7 h-px w-full overflow-hidden bg-[#E4E7EC]"
//               >
